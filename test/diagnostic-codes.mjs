...
const shared = new Map([
  ...
  ["E3033", "a module qualifier that exports no such member, from an expression and from a constructor pattern"],
  ["E3034", "a variant a type does not have or a named variant used as a value, from expressions and from constructor patterns"],
  ...
  ["E7005", "a computed integer result that its declared kind cannot hold"],
