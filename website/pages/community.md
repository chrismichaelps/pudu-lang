...
- **[Discussions](https://github.com/chrismichaelps/pudu-lang/discussions)** — questions about how to
  write something, and proposals before they are issues.
...
Questions are welcome in Discussions, including ones you think are obvious. If the documentation led
you astray, that is a documentation bug, and saying which page and what you expected is more useful
