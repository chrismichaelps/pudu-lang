...
effectSignatures =
  ...
  , ("childCloseInput", monotype (FunctionTypeValue False [integerType] (resultOf unitTypeValue)))
  , ("childWait", monotype (FunctionTypeValue False [integerType] (resultOf integerType)))
  , ("childWaitWithin", monotype (FunctionTypeValue False [integerType, integerType] (resultOf (NominalType "Option" [integerType]))))
  , ("childStop", monotype (FunctionTypeValue False [integerType] (resultOf integerType)))
  ...
  , ("gzipCompress", monotype (FunctionTypeValue False [bytesType, integerType, integerType] (resultOf bytesType)))
  , ("deflateRaw", monotype (FunctionTypeValue False [bytesType, integerType, integerType] (resultOf bytesType)))
  , ("inflateRaw", monotype (FunctionTypeValue False [bytesType, integerType] (resultOf bytesType)))
  , ("gzipDecompress", monotype (FunctionTypeValue False [bytesType, integerType] (resultOf bytesType)))
  , ("tlsUpgradeWithin", monotype (FunctionTypeValue False [integerType, stringType, integerType] (resultOf integerType)))
