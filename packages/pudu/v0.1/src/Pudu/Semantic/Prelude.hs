...
preludeValueNames =
  ...
  , "wordMapPopCount", "wordMapMembers", "sha256Of", "sha512Of", "sha3_256Of", "sha3_512Of", "blake2b256Of", "blake2b512Of", "hmacSha512Of", "constantTimeEqual", "sealBytes", "openSealedBytes", "verifyRsaSha256", "verifyEcdsaSha256", "hmacSha256Of", "deriveKey", "hashOf"
...
effectValueNames =
  ...
  , "gzipCompress", "gzipDecompress", "deflateRaw", "inflateRaw", "tlsUpgradeWithin", "tlsConnect", "tlsConnectWithin", "tlsSend", "tlsSendWithin"
  ...
  , "secureRandomBytes"
  , "desktopOpen", "desktopPresent", "desktopPump", "desktopInputs", "desktopClipboardRead", "desktopClipboardWrite", "desktopAccessibility", "desktopAccessibilityReport", "desktopClose", "audioDevicePlay"
