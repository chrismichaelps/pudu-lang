...
installBuiltinConstructors = do
  ...
  bind "bufferAlloc" (BuiltinValue BufferAllocBuiltin)
  bind "bufferReadU64" (BuiltinValue BufferReadU64Builtin)
  bind "bufferWriteU64" (BuiltinValue BufferWriteU64Builtin)
  bind "bufferScanU64" (BuiltinValue BufferScanU64Builtin)
  bind "bufferCopy" (BuiltinValue BufferCopyBuiltin)
  bind "bufferSize" (BuiltinValue BufferSizeBuiltin)
  bind "swissTableEmpty" (BuiltinValue SwissTableEmptyBuiltin)
  bind "swissTableLookup" (BuiltinValue SwissTableLookupBuiltin)
  bind "swissTableInsert" (BuiltinValue SwissTableInsertBuiltin)
  ...
  bind "bufferWriteF64" (BuiltinValue BufferWriteF64Builtin)
  bind "bufferReadU32" (BuiltinValue BufferReadU32Builtin)
  bind "bufferWriteU32" (BuiltinValue BufferWriteU32Builtin)
  bind "bufferFill" (BuiltinValue BufferFillBuiltin)
  bind "bufferCompare" (BuiltinValue BufferCompareBuiltin)
  bind "columnSumU64" (BuiltinValue ColumnSumU64Builtin)
  bind "columnMinU64" (BuiltinValue ColumnMinU64Builtin)
  bind "columnMaxU64" (BuiltinValue ColumnMaxU64Builtin)
  bind "columnFilterGtU64" (BuiltinValue ColumnFilterGtU64Builtin)
  bind "columnProjectU64" (BuiltinValue ColumnProjectU64Builtin)
  bind "columnSumF64" (BuiltinValue ColumnSumF64Builtin)
  bind "columnMinF64" (BuiltinValue ColumnMinF64Builtin)
  bind "columnMaxF64" (BuiltinValue ColumnMaxF64Builtin)
  bind "columnFilterGtF64" (BuiltinValue ColumnFilterGtF64Builtin)
  bind "columnFilterLtF64" (BuiltinValue ColumnFilterLtF64Builtin)
  bind "columnProjectF64" (BuiltinValue ColumnProjectF64Builtin)
  bind "columnAddF64" (BuiltinValue ColumnAddF64Builtin)
  bind "columnBitmapAnd" (BuiltinValue ColumnBitmapAndBuiltin)
