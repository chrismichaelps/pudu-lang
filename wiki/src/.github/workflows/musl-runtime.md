...
to that copy, binds its dependencies to their packaged `/var/task` paths, packages the musl shared
dependencies reported by the runtime beside it, and executes it in both Alpine
