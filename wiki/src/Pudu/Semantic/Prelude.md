...
`desktopOpen`, `desktopPresent`, `desktopPump`, `desktopInputs`, `desktopClipboardRead`, `desktopClipboardWrite`, `desktopAccessibility`, `desktopAccessibilityReport`, and `desktopClose` are discoverable effect values.
