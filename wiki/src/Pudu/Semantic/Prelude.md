...
Separate the types the compiler wires in from the names an implicitly imported prelude module supplies, following the same split Haskell uses between wired-in types and the `Prelude` library module.
