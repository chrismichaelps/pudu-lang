...
See [[architecture/PACKAGES]] · [[Package install suite]].

## Grill Log

- **Q:** Separate package-manager executable? **A:** No. _Rationale:_ one tool. _Rejected:_ a second binary.

Resolved Grill Log: behaviour covered by `test/Pudu/PackageSpec.hs` and, from a terminal, by [[Package install suite]].
