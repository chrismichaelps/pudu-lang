...
- [[src/Pudu/Frontend/Parser/_MOC|Parser modules]] — strict bounded state plus segmented-name, unresolved-type, precedence-expression, and modular import grammar.
