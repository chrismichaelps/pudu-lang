...
- No `read`, `Int`, `Integer`, floating conversion, magnitude bound, suffix type checking, leading-sign ownership, uppercase base prefix, hex float, recovery rewind, or parser policy.
