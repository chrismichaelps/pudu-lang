...
- 2026-08-23 · [[Parser Expression]], [[Eval Operator]], [[grammar/pudu]] · wire `|` as a bitwise OR binary operator (precedence 1, same band as `||`); `&` remains borrow-only (approach a) pending a Language Architect decision on dual-role syntax · risk LOW · depth DEEP→DEEP · issue #54
