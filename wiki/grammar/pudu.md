...
- A built-in collection method answers with a new collection rather than changing its receiver. Writing one as a statement therefore does nothing, and is reported as `W3002`.
