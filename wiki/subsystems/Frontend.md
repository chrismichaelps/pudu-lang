...
[[Token]] defines the vocabulary; [[Lexer Facade]] exposes lossless tokenization; [[Syntax]] exposes the recovery tree. [[Parser State]] owns bounded suffix traversal, [[Parser Name]] owns spelling classes and segmented paths, [[Parser Type]] owns unresolved types, [[Parser Expression]] owns precedence, [[Parser Import]] owns explicit module dependencies, and [[Parser Binding]] owns scope-safe binding syntax.
...
[[architecture/OVERVIEW]] · [[Semantics]] · [[Tooling]] · [[Token]] · [[Lexer Facade]] · [[Syntax]] · [[Parser State]] · [[Parser Name]] · [[Parser Type]] · [[Parser Expression]] · [[Parser Import]] · [[Parser Binding]] · [[src/Pudu/Frontend/_MOC]]
